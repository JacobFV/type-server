export function generateControllerBase<T extends typeof Model>(modelType: T) {
  ...
  // also add field level getters&setters with permissions enforced based on the @Field annotations
